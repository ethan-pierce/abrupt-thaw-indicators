"""Figure 6 — Representativeness / sampling-bias honesty gate (L4c).
...
across space (Fig 5 / L3). Coverage (the AOA, Fig 4b) and density
...
Writes output/fig06_representativeness.{pdf,png}.
"""
...
def main():
    ...
    figstyle.save(fig, "fig06_representativeness")
    plt.close(fig)
    print("wrote output/fig06_representativeness.{pdf,png}")
